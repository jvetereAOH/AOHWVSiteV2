...
export default function CSMA() {
    ...
    <div className="Blog">
        <Container className="blogcontent">
            ...
            <img className="img-mesh roundedborder" src={csma1} alt="Layout map of described cyber security mesh network"/>

            <p className="text-muted">SIEM & SOAR with an aggregation point.</p>
            <img className="img-mesh roundedborder" src={csma2} alt="Layout map of with aggregation point" />

            <p className="text-muted"> Moving on to Security Intelligence, Threat Intelligence, Work flow & Automation.  </p>
            <img className="img-mesh roundedborder" src={csma3} alt="Automation map of security"/>

            <p className="text-muted"> MUST add in Identity.</p>
            <img className="img-mesh roundedborder" src={csma4} alt="Layout showing multi layer identity verification"/>

            <p className="text-muted">Posture & playbook managment</p>
            <img className="img-mesh roundedborder" src={csma5} alt="posture and playbook map" />
